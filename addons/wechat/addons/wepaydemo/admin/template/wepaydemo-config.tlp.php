                        ...
                        <table width="100%" class="insert-tab">
                            <tbody>
								<tr class="formtr">
                                    ...
                                    <td class="formtd">
                                 	<input type="text" class="common-text" name="config[wechat_wepaydemo_seo_title]" value="{$PW['wechat_wepaydemo_seo_title']}" size="36" />
                                    </td>

                                </tr>
                                <!--
                                您可以无限拓展配置的选项 不过值请以 wechat_wepaydemo_ 开头，以防止跟其他模块选项值冲突
                                您可以在前台用 $PW['wechat_wepaydemo_example'] 读取这个选项

                                <tr class="formtr">
                                    <th class="formth" width="20%"><i class="require-red">*</i>选项：</th>
                                    <td class="formtd">
                                    <input type="text" class="common-text" name="config[wechat_wepaydemo_example]" value="{$PW['wechat_wepaydemo_example']}" size="36" />
                                    </td>
