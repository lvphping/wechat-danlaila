        ...
        <div class="result-wrap">
            ...
            <div class="result-content">
                <ul class="sys-info-list">
                    ...
                    <li>
                        <label class="res-lab">您的当前IP：</label><span class="res-info"><?php echo defined('CLIENT_IP')?CLIENT_IP:'{__CLIENT_IP__}';?></span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="result-wrap" style="clear:both">
            ...
            <div class="result-content">
                <ul class="sys-info-list">
                    ...
                    <li>
                        <label class="res-lab">程序版本：</label><span class="res-info">Version <?php echo defined('PHPWECHAT_VERSION')?PHPWECHAT_VERSION:'{__PHPWECHAT_VERSION__}';?><?php echo defined('PHPWECHAT_RELEASE')?PHPWECHAT_RELEASE:'{__PHPWECHAT_RELEASE__}';?> </span>
                    </li>
                    <li>
